...
-- INSERT INTO supplements (name, description, manufacturer, cost, quantity, images, created_at, updated_at, deleted_at) VALUES
...
-- ('Essential Vegan Multivitamin', 'Essential Vegan Multivitamin for Plant-Based Diets - 90 Veg Tablets with B12, D3, Calcium, Iron, Zinc & More. VEGANLY Vitamins Canada', 'VEGANLY Vitamins', 53.99, 90, '{"image3": "https://m.media-amazon.com/images/I/61mYKPeNbxL._AC_SL1500_.jpg"}', NOW(), NOW(), NULL),
...
-- ('NATURELO One Daily Multivitamin for Women', 'NATURELO One Daily Multivitamin for Women - Energy Support - Whole Food Supplement to Nourish Hair, Skin, Nails - Non-GMO - No Soy - Gluten Free - 120 Capsules | 4 Month Supply', 'NATURELO', 46.95, 120, '{"image5": "https://m.media-amazon.com/images/I/71XN3Lm6-CL._AC_SL1500_.jpg"}', NOW(), NOW(), NULL),
-- ('womens multi', 'Womens Multi (18+) – Vitality & Beauty Formula, Boosts Energy, Immunity & Overall Health With Essential Vitamins, Minerals, Antioxidants, Fruit & Herbal Blends - 60 Vegan Capsules', 'NuBest', 45.55, 60, '{"image6": "https://www.nubest.com/cdn/shop/files/womensmulti-avatar.png?v=1700881139&width=1946"}', NOW(), NOW(), NULL),
-- ('NUTRAMIN', 'NUTRACELLE NUTRAMIN Daily Vegan Keto Multivitamin Gummies Vitamin C, D2, and Zinc for Immunity, Plant-Based, Sugar-Free, Nut-Free, Gluten-Free, Vitamin A, B, B6, B12 & More 90 Count, 45 Day Supply', 'Nutracelle', 23.39, 90, '{"image7": "https://m.media-amazon.com/images/I/81NMqZpNSnL._AC_SL1500_.jpg"}', NOW(), NOW(), NULL),
-- ('Creatine Monohydrate', 'Creatine Monohydrate 1000 mg Capsules by Nutritionn - 3-5 g Serving, 150 Capsules - Increases Lean Muscle Mass - Premium Bodybuilding and Sports Supplement', 'Nutritionn', 24.99, 150, '{"image8": "https://m.media-amazon.com/images/I/61wYwNV6-YL._AC_SL1500_.jpg"}', NOW(), NOW(), NULL),
...
(1, 60, 'intake', 'capsule', '2023-12-31', '2025-07-31', 'iHerb', 49.99, NOW(), NOW(), NULL),
(2, 30, 'intake', 'tablet', '2023-12-31', '2024-02-12', 'Amazon', 60.99, NOW(), NOW(), NULL),
(3, 60, 'intake', 'tablet', '2023-12-31', '2024-09-24', 'Alive Health', 60.74, NOW(), NOW(), NULL),
(4, 90, 'intake', 'softgel', '2023-12-31', '2025-10-02', 'iHerb', 49.95, NOW(), NOW(), NULL),
(5, 60, 'restock', 'capsule', '2023-12-31', '2025-07-31', 'iHerb', 53.99, NOW(), NOW(), NULL),
(6, 30, 'intake', 'capsule', '2023-12-31', '2024-05-16', 'Alive Health', 60.99, NOW(), NOW(), NULL),
(7, 60, 'intake', 'capsule', '2023-12-31', '2024-08-25', 'Amazon', 34.99, NOW(), NOW(), NULL),
(8, 30, 'restock', 'capsule', '2023-12-31', '2025-06-29', 'iHerb', 40.99, NOW(), NOW(), NULL),
(9, 60, 'intake', 'softgel', '2023-12-31', '2025-03-21', 'Alive Health', 56.99, NOW(), NOW(), NULL),
(10, 120, 'intake', 'capsule', '2023-12-31', '2025-04-10', 'iHerb', 77.99, NOW(), NOW(), NULL);
-- -- Inserting values into the user_supplements table

-- INSERT INTO user_supplements (userId, supplementId, number_of_pills_taken, time_taken, effectiveness) VALUES
-- (1, 1, 2, NOW(), 'Effective'),
-- (2, 3, 1, NOW(), 'Moderate'),
-- (1, 2, 3, NOW(), 'Very Effective'),
-- (3, 4, 2, NOW(), 'Effective'),
-- (2, 5, 1, NOW(), 'Moderate'),
-- (3, 6, 2, NOW(), 'Effective'),
-- (1, 7, 3, NOW(), 'Very Effective'),
-- (2, 8, 2, NOW(), 'Effective'),
-- (3, 9, 1, NOW(), 'Moderate'),
-- (1, 10, 2, NOW(), 'Very Effective');
...
-- Inserting values into skips table

  INSERT INTO skips (supplementUsageId, date_skipped)
VALUES
  (1, '2023-01-01 12:00:00'),
  (2, '2023-02-15 14:30:00'),
  (3, '2023-03-05 08:45:00'),
  (4, '2023-04-20 18:20:00'),
  (5, '2023-05-10 10:00:00'),
  (6, '2023-06-08 16:45:00'),
  (7, '2023-07-03 09:30:00'),
  (8, '2023-08-21 20:15:00'),
  (9, '2023-09-12 11:45:00'),
  (10, '2023-10-30 17:00:00');